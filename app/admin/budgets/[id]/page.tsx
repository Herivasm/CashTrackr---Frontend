...
import { getBudget } from '@/src/api/budgets'
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: `Editando el presupuesto de: ${budget.name}`
    }
}
        ...
        <>
            ...
            {budget.expenses.length ? (
                <>
                    ...
                    <ul role="list" className="divide-y divide-gray-300 border border-gray-100 shadow-lg mt-10 ">
